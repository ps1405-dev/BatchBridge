...
export async function POST(request) {
  try {
    ...
    const businesses=leads.map(x=>({id:x.id,name:x.business_name,source_category:x.offer,source:x.source,distance_km:maker.latitude&&x.latitude?distanceKm(Number(maker.latitude),Number(maker.longitude),Number(x.latitude),Number(x.longitude)):null}));
